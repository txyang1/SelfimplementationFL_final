...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):  # 循环进行多个训练轮次 default=10 t= 1,2,3....
        ...
        # LDP
        C = args.C  # Gradient norm bound
        sigma = args.sigma  # Noise scale
    ...
    with open('./result/z_sigma_attack_before_ldp_grad_in_train_{}_{}_attack_{}_epsilon_{}_addtime_{}_malicious_{}_epoch_{}_users_{}_sigma_{}_C_{}.txt'.format(args.dataset, args.Agg, args.attack, args.epsilon, args.addtime, args.malicious, args.epochs, args.frac, args.sigma, args.C), 'w') as f:
