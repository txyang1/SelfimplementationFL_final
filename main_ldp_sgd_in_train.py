...
from models.update1 import LocalUpdate4
...
# If you are using CUDA, set the seed for the GPU as well
...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):  # 循环进行多个训练轮次 default=10 t= 1,2,3....
        ...
        for idx in idxs_users:  # ：遍历选定的客户端 k k=1,...,10
            ...
            local = LocalUpdate4(args=args, dataset=dataset_train, idxs=dict_users[idx])# dict_users是一个字典，idxs=dict_users[idx]是第idx个用户被分配的图像索引的集合
    ...
    with open('./result/test_ldp_sgd_result_train_{}_{}_attack_{}_epsilon_{}_addtime_{}_malicious_{}_epoch_{}_users_{}_sigma_{}_C_{}.txt'.format(args.dataset,args.Agg, args.attack,args.epsilon,args.addtime,args.malicious,args.epochs,args.frac,args.sigma,args.C), 'w') as f:
